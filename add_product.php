...
";
    ...
    $product_category = explode("+", $raw_product_category)[1];
    $product_category_id = explode("+", $raw_product_category)[0];
    $raw_product_sub_category = $_POST["product_sub_category"];
    $product_sub_category = explode("+", $raw_product_sub_category)[1];
    $product_sub_category_id = explode("+", $raw_product_sub_category)[0];
    $raw_warehouse = $_POST["warehouse_name"];
    $warehouse_name = explode("+", $raw_warehouse)[1];
    $warehouse_id = explode("+", $raw_warehouse)[0];
    $warehouse_address = explode("+", $raw_warehouse)[2];
    $raw_warehouse_section = $_POST["warehouse_section"];
    $warehouse_section_name = explode("+", $raw_warehouse_section)[1];
    $warehouse_section_id = explode("+", $raw_warehouse_section)[0];
    $raw_warehouse_sub_section = $_POST["warehouse_sub_section"];
    $warehouse_sub_section_name = explode("+", $raw_warehouse_sub_section)[1];
    $warehouse_sub_section_id = explode("+", $raw_warehouse_sub_section)[0];
